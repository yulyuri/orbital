        ...
        <ImageBackground source={require("../assets/images/Friends1.png")} style={styles.signUp}>
            ...
            <View style={styles.container} >
                <View style={{ alignItems: "center", gap: widthPercentageToDP(2), marginTop: heightPercentageToDP(5) }} >
                    <Text style={{ fontWeight: "bold", fontSize: widthPercentageToDP(6) }} >Are you more of an extrovert or an introvert?</Text>
                </View>
                ...
                <View>
                    ...
                    <View style={styles.answerContainer} >
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }} >
                            <Text style={{ fontSize: 17 }} >Introvert</Text>
                            <RadioButton
                                label="Option 1"
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }} >
                            <Text style={{ fontSize: 17 }} >Extrovert</Text>
                            <RadioButton
                                label="Option 2"
