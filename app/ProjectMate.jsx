        ...
        <ImageBackground source={require("../assets/images/Friends1.png")} style={styles.signUp}>
            ...
            <View style={styles.container} >
                <View style={{ alignItems: "center", gap: widthPercentageToDP(2), marginTop: heightPercentageToDP(5) }} >
                    <Text style={{ fontWeight: "bold", fontSize: widthPercentageToDP(6) }} >Work style?</Text>
                </View>
                ...
                <View>
                    ...
                    <View style={styles.answerContainer} >
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }} >
                            <Text style={{ fontSize: 17,width:"70%" }} >Prefer regular meetings and discussions</Text>
                            <RadioButton
                                label="Option 1"
                        ...
                        <View style={{ flexDirection: "row", justifyContent: "space-between", alignItems: "center" }} >
                            <Text style={{ fontSize: 17,width:"90%"}} >Prefer working independently with occasional check-ins</Text>
                            <RadioButton
                                label="Option 2"
                ...
                <View style={{ gap: 2 }} >
                    ...
                    <View style={styles.importantButtonContainer} >
                        <TouchableOpacity onPress={()=>setSelectedImportant("A little")} style={{ color: "#0500FF", width: widthPercentageToDP(25), alignItems: "center", justifyContent: "center", borderRightColor: "#0500FF", borderRightWidth: 1, height: "100%" ,backgroundColor:selectedImportant ==="A little" ? "#ADD8E6":"transparent"}}>
                            <Text style={{ color: "#0500FF" }} >A little</Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>setSelectedImportant("Somewhat")} style={{ color: "#0500FF", width: widthPercentageToDP(30), alignItems: "center", justifyContent: "center", borderRightColor: "#0500FF", borderRightWidth: 1, height: "100%" ,backgroundColor:selectedImportant ==="Somewhat" ? "#ADD8E6":"transparent"}}>
                            <Text style={{ color: "#0500FF" }} >Somewhat
                            </Text>
                        </TouchableOpacity>
                        <TouchableOpacity onPress={()=>setSelectedImportant("Very")} style={{ color: "#0500FF", width: widthPercentageToDP(25), alignItems: "center", justifyContent: "center", height: "100%",backgroundColor:selectedImportant ==="Very" ? "#ADD8E6":"transparent" }}>
                ...
                <View style={styles.bottomButtonContainer}>
                    ...
                    <TouchableOpacity onPress={() => navigation.navigate("(tabs)")} activeOpacity={0.7} style={{ gap: 5 }} >
                        <Image
