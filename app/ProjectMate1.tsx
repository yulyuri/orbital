...
//                         <TouchableOpacity onPress={()=>setSelectedImportant("A little")} style={[styles.importButton, {backgroundColor:selectedImportant ==="A little" ? "red":"transparent"}]}>
//                             <Text style={{ color: "#0500FF" }} >A little</Text>
//                         </TouchableOpacity>
//                         <TouchableOpacity onPress={()=>setSelectedImportant("Somewhat")} style={[styles.importButton, {backgroundColor:selectedImportant ==="Somewhat" ? "red":"transparent"}]}>
//                             <Text style={{ color: "#0500FF" }} >Somewhat</Text>
//                         </TouchableOpacity>
//                         <TouchableOpacity onPress={()=>setSelectedImportant("Very")} style={[styles.importButton, {backgroundColor:selectedImportant ==="Very" ? "red":"transparent"}]}>
//                             <Text style={{ color: "#0500FF" }} >Very</Text>
//                         </TouchableOpacity>
//                     </View>
//                 </View>
