...
//                     <TouchableOpacity onPress={() => router.navigate("LookingFor")} activeOpacity={0.7} style={{ gap: 5, alignItems: "center" }}>
//                         <Image
...
//                     </TouchableOpacity>
//                     <TouchableOpacity onPress={() => router.navigate("tabs")} activeOpacity={0.7} style={{ gap: 5 }}>
//                         <Image
